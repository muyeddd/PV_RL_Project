"""Run leakage-free formal ResNet50+I cross-validation for date_grouped_v1."""
...
FORMAL_OUTPUT_ROOT = (
    PROJECT_ROOT / "outputs" / "date_grouped_v1" / "resnet50_with_i" / "formal_cv"
)
FOLDS = (1, 2, 3, 4)
SEED = 42
EPOCHS = 50
...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run formal date_grouped_v1 ResNet50+I cross-validation"
    )
...
def write_cv_summary(started_at_utc: str) -> dict[str, Any]:
    ...
    summary = {
        "schema_version": 1,
        "training_version": "resnet50_with_i_date_grouped_v1",
